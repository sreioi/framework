...
func (r *GormImpl) Make() (*gormio.DB, error) {
	...
	writeDialectors, err := r.dialector.Make([]database.Config{writeConfigs[0]})
	if err != nil {
...
func (r *GormImpl) configureReadWriteSeparate(readConfigs, writeConfigs []database.Config) error {
